...
<head>
  ...
  <title>Maria lalij - Développeuse PHP</title>
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="index.html">a Propos de moi</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="about.html">Blogs</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="post.html">Se Connecter</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Maria lalij</h1>
            <span class="subheading">Développeuse PHP</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="../public/startbootstrapjs/clean-blog.min.js"></script>
